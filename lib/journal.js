...
export async function reanchor(_issue) {
  // TODO(stage 2): the consumer is the SessionStart hook, which lands with the
  // hook handlers. Building the view before anything injects it would freeze a
  // format nothing has read yet.
