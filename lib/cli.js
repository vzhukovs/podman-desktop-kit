  ...
  if (action === 'new') {
    ...
    const path = await render.write({
      ...
      values: {
        ...
        quote: '<the reviewer\'s words, quoted>',
        url: url || '',
        whySeparate: '<the layer argument, in a form the reviewer who raised it would accept>',
        layer: '<pdkit packages --of <path>>',
        doneWhen: '<what a person should see>',
        ...values,
      },
    });
