...
/**
 * What was tried before: the attempt, what backed it out, and what reviewers
 * said about it.
 *
 * Required before the `redo` route may leave triage, because planning a second
 * attempt without reading the first is how the same approach gets refused twice.
 * `gaps` is part of the answer rather than an apology for it — a report that
 * quietly omits what it could not establish reads as "nothing was found".
 *
