...
/**
 * Something in the shipped knowledge base that no longer matches the repository
 * it describes.
 *
 * Facts for a revision a human makes, not edits to apply: `knowledge/` is read
 * by every later issue and nobody re-derives what it states as settled, which
 * is exactly why being quietly wrong there is expensive — and why correcting it
 * automatically would be worse.
 *
