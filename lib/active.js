...
/**
 * What one working tree is executing right now.
 *
 * Keyed by tree rather than by issue, which is the reason this is not a field on
 * the issue record: five worktrees share one $PDKIT_HOME, and two of them can
 * drive the same issue on different slices. One field could not hold both
 * answers, and two writers of state.json would breach invariant 1.
 *
